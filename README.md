...
[![.NET CI/CD Pipeline](https://github.com/oop-jccc/exceptions-in-class/actions/workflows/ci.yml/badge.svg)](https://github.com/oop-jccc/exceptions-in-class/actions/workflows/ci.yml)
...
3. **Restore Dependencies:**
   ```bash
   dotnet restore exceptions-in-class.sln
   ```
...
```
exceptions-in-class/
â”œâ”€â”€ exceptions-in-class.csproj    # Project configuration
